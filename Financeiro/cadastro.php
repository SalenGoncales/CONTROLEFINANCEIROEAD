                    ...
                    <?php
                        ...
                        <form action="cadastro.php" method="post">
                            ...
                            <div class="form-group input-group">
                                ...
                                <input type="password" class="form-control" placeholder="Crie uma senha (mínimo de 6 caracteres)" name="senha" />
                            </div>
                            <div class="form-group input-group">
                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                <input type="password" class="form-control" placeholder="Repita a senha criada" name="rsenha" />
                            </div>

                            <button class="btn btn-success" name="btnFinalizar">Finalizar Cadastro</button>
                            <hr />

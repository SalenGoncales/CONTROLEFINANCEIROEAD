            ...
            <div id="page-inner">
                ...
                <form action="realizar_movimento.php" method="post">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label>Data*</label>
                            <input type="date" class="form-control" placeholder="Digite a data do movimento" id="data" name="data" />
                    ...
                    <div class="col-md-12">
                        ...
                        <div>
                            <button type="submit" onclick="return RealizarMovimento()" class="btn btn-success" name="btnFinalizar">Finalizar lançamento</button>
                        </div>
                </form>
            </div>
            <!-- /. PAGE INNER  -->

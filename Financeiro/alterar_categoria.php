            ...
            <div id="page-inner">
                ...
                <form method="post" action="alterar_categoria.php">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Digite o nome da categoria. Exemplo: conta de luz" id="nome" value="<?= $dados[0]['nome_categoria'] ?>" name="nomecategoria" maxlength="35" />
                        <br>
